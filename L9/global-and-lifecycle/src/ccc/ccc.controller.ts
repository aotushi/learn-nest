    ...
    OnApplicationShutdown
{
  ...
  onModuleInit() {
    console.log('CccControl onModuleInit');
  }
  onApplicationBootstrap() {
    console.log('CccControl onApplicationBootstrap');
  }

  onModuleDestroy() {
    console.log('CccControl onModuleDestroy');
  }

  beforeApplicationShutdown(signal?: string) {
    console.log('CccControl beforeApplicationShutdown', signal);
  }

  onApplicationShutdown(signal?: string) {
    console.log('CccControl onApplicationShutdown', signal);
  }
